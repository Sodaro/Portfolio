...
<nav class="top-0 left-0 lg:top-16 sticky h-full w-1/5 z-50 bg-base-100 not-prose">
  ...
  <div class="hidden lg:flex lg:flex-col lg:gap-2 lg:text-xl">
    ...
    <div
      id="navicons"
      class="right-0 flex flex-row gap-4 justify-center"
    >
      <a
      ...
      <a href="https://sodaro.itch.io/" target="_blank" rel="noopener noreferrer"  class="w-fit">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-10 w-10"
      ...
      <a href="mailto:david.bang@outlook.com" target="_blank" rel="noopener noreferrer" >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-10"
          viewBox="0 0 50 50"
