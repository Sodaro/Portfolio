...
<nav class="sticky top-0 lg:h-full lg:w-2/12 z-50 bg-base-100 not-prose">
  <div class="h-fit z-50 navbar lg:hidden w-full flex justify-between">
    ...
    <label class="btn btn-outline swap swap-rotate p-0 self-center w-fit">
  ...
  <div class="hidden lg:drawer">
    <div class="drawer-side overflow-y-auto flex flex-col gap-4 pr-4">
      <div class="sticky top-0 bg-base-100 z-20">
        <div class="item italic hover:bg-base-200 py-4">
          <a href="/" class="flex flex-col">
            <p class="text-2xl 2xl:text-5xl font-bold">David Bång</p>
            <p class="text-xl 2xl:text-2xl">Portfolio</p>
          </a>
        </div>
        ...
        >
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              class="h-10 w-10 bi bi-linkedin"
              viewBox="0 0 16 16"
            >
              <path
        ...
        <div class="flex flex-row lg:flex-col gap-2 pt-8 lg:justify-start">
