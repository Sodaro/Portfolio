<script>
  ...
  <nav class="top-0 left-0 lg:top-16 sticky h-full z-50 bg-base-100 not-prose">
    ...
    <ul class="menu w-full hidden lg:text-xl lg:flex lg:flex-col lg:py-4 h-fit">
      
      <li class="item px-4 italic">
      ...
      <li class="item w-fit pl-4 py-4 self-center">
        <ButtonLink isDownloadButton=true href="/davidbang_resume.pdf">Resume</ButtonLink>
      </li>

      <div id="navicons" class="right-0 flex flex-row gap-4 py-4 pl-4 justify-center  ">
        <a
        ...
        <a href="mailto:david.bang@outlook.com">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-10"
            viewBox="0 0 50 50"
      ...
      <li class="item">
        <label class="rounded swap swap-rotate w-3/4 self-center">
