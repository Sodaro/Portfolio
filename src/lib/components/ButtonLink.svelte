...
<a href={href} target="_blank" class="link btn btn-primary text-white font-bold py-2 px-4 rounded col-span-2 normal-case no-underline text-lg" rel="noopener noreferrer">
    <div class="flex gap-x-4 text-center items-center">
        {#if isGithubLink}
        <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        class="h-8 w-8 bi bi-github"
        viewBox="0 0 16 16"
      >
      <path
