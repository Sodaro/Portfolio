...
<header class="left-0 top-0 fixed w-full z-50">
  <nav>
    ...
    <ul class="menu w-56 hidden lg:flex rounded-box">
      <li class="item">
...
<section id="welcome" class="w-full h-screen grid place-items-center">
  <div
    id="welcomegrid"
...
<section id="featuredprojects" class="mycolsection">
  ...
  <div class="games flex flex-col lg:flex-row   gap-x-4">
    <VidCard
      ...
      src="/UnrealEnigmaMachine.mp4"
      alt="video of EnigmaMachine"
      title="Enigma Machine"
      descr="Enigma Machine made in Unreal C++"
    />
    <Card
    ...
    <Card
      ...
      alt="DIZT"
      title="DIZT"
      descr="Ludum Dare 50 Entry. Action game with horror aesthetic made in Unity."
    />
  </div>
</section>
<section
