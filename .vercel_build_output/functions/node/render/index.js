...
function fromRawHeaders(headers = []) {
  return new Headers2(headers.reduce((result, value, index10, array2) => {
    if (index10 % 2 === 0) {
      result.push(array2.slice(index10, index10 + 2));
    }
    return result;
  }, []).filter(([name, value]) => {
    try {
...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
    ...
    _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"min-h-screen"}"><div class="${"container mx-auto pt-10"}">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}</div>
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    index = 0;
    entry = "pages/__layout.svelte-1841c6db.js";
    js = ["pages/__layout.svelte-1841c6db.js", "chunks/index-f6b2bc5e.js"];
    css = ["assets/pages/__layout.svelte-d7377e20.css"];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    index2 = 1;
    entry2 = "error.svelte-b1bf81ca.js";
    js2 = ["error.svelte-b1bf81ca.js", "chunks/index-f6b2bc5e.js"];
    css2 = [];
  }
});
...
var init_index_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/index.svelte.js"() {
    ...
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${"mysection"}"><div class="${"avatar"}"><div class="${"w-64 mask mask-squircle"}"><img src="${"/profilepic.jpg"}" alt="${"dave"}"></div></div>
    <div class="${"mb-10 p-10"}"><h2 class="${"py-4 text-xl font-bold"}">Hi!</h2>
      <p>My name is David B\xE5ng. I&#39;m a programmer who loves making gameplay mechanics and systems. I&#39;m currently studying gameprogramming at Futuregames.</p>
      <p>Languages: Fluent in C#, comfortable with C++ and Lua. Experienced with Unity, currently working in Unreal Engine.</p>
      
      <div class="${"mysocialicons flex py-4 gap-x-4"}"><a href="${"https://twitter.com/Sodaro_"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" fill="${"currentColor"}" class="${"h-10 bi bi-twitter"}" viewBox="${"0 0 16 16"}"><path d="${"M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"}"></path></svg></a>
        <a href="${"https://github.com/Sodaro"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" fill="${"currentColor"}" class="${"h-10 bi bi-github"}" viewBox="${"0 0 16 16"}"><path d="${"M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"}"></path></svg></a>
        <a href="${"https://www.linkedin.com/in/david-b%C3%A5ng-51742921a/"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" fill="${"currentColor"}" class="${"h-10 bi bi-linkedin"}" viewBox="${"0 0 16 16"}"><path d="${"M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"}"></path></svg></a>
        <a href="${"https://sodaro.itch.io/"}"><img class="${"h-10"}" src="${"/itchio-textless-white.svg"}"></a>
        <a href="${"mailto:email@address.com"}" class="${"btn btn-primary text-white font-bold py-2 px-4 rounded"}">Contact!</a>
        </div></div></div>
<div class="${"mysection flex-col"}"><h2 class="${"py-4 text-lg font-bold"}">Featured Projects</h2>
  <div class="${"games flex flex-row gap-x-4"}"><a href="${"/projects/enigma-machine"}"><div class="${"card w-96 h-full bg-neutral shadow-xl"}"><figure class="${""}"><video class="${"h-72"}" muted><source src="${"/UnrealEnigmaMachine.mp4"}" type="${"video/mp4"}">
            Your browser does not support the video tag.
          </video>
          </figure>
        <div class="${"card-body"}"><h3 class="${"card-title"}">Enigma Machine</h3>
          <p>Interactible Enigma machine made in Unreal.</p></div></div></a>
    <a href="${"/projects/pumpkin-boy"}"><div class="${"card w-96 h-full bg-neutral shadow-xl"}"><figure class="${""}"><img class="${"object-cover h-72"}" src="${"/pumpkinboy.png"}" alt="${"Pumpkin Boy Project"}"></figure>
      <div class="${"card-body"}"><h3 class="${"card-title"}">Pumpkin Boy</h3>
        <p>Thirdperson Puzzle game made in Unity.</p></div></div></a>
    <a href="${"/projects/dizt"}"><div class="${"card w-96 h-full bg-neutral shadow-xl"}"><figure class="${""}"><img class="${"object-cover h-72"}" src="${"dizt.png"}" alt="${"DIZT"}"></figure>
      <div class="${"card-body"}"><h3 class="${"card-title"}">DIZT</h3>
        <p>Ludum Dare 50 Entry. Action game with horror aesthetic made in Unity.</p></div></div></a></div></div>
<div class="${"mysection flex-col"}"><h2 class="${"text-lg font-bold"}">Education</h2>
  <ul><li>Game Design: Uppsala University 2016-2019</li>
    <li>Gameprogrammer: Futuregames 2021-2023</li></ul></div>
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    init_index_svelte();
    index3 = 2;
    entry3 = "pages/index.svelte-cbb2aa8a.js";
    js3 = ["pages/index.svelte-cbb2aa8a.js", "chunks/index-f6b2bc5e.js"];
    css3 = [];
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/8.js"() {
    ...
    index4 = 8;
    entry4 = "pages/projects.svelte-dd07ef98.js";
    js4 = ["pages/projects.svelte-dd07ef98.js", "chunks/index-f6b2bc5e.js"];
    css4 = [];
  }
});

// .svelte-kit/output/server/entries/pages/projects/addons.md.js
var addons_md_exports = {};
__export(addons_md_exports, {
  default: () => Addons,
  metadata: () => metadata
});
var metadata, Addons;
var init_addons_md = __esm({
  ".svelte-kit/output/server/entries/pages/projects/addons.md.js"() {
    init_index_5f038599();
    metadata = { "title": "Addons", "date": "2021-12-14" };
    Addons = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<h1>Uses</h1>
<p><strong>WoW Addons</strong>\u{1F93A}\u{1F47A}</p>
<ul><li>SodaChatFilter</li>
<li>SodaDungeons</li>
<li>SodaQuestAnnouncer</li>
<li>SodaBarHider</li></ul>
...
<ul class="${"contains-task-list"}"><li class="${"task-list-item"}"><input type="${"checkbox"}" checked disabled> Write the press release</li>
<li class="${"task-list-item"}"><input type="${"checkbox"}" disabled> Update the website</li>
<li class="${"task-list-item"}"><input type="${"checkbox"}" disabled> Contact the media</li></ul>`;
    });
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    init_addons_md();
    index5 = 3;
    entry5 = "pages/projects/addons.md-b2248569.js";
    js5 = ["pages/projects/addons.md-b2248569.js", "chunks/index-f6b2bc5e.js"];
    css5 = [];
  }
});

// .svelte-kit/output/server/entries/pages/projects/dizt.md.js
var dizt_md_exports = {};
__export(dizt_md_exports, {
  default: () => Dizt,
  metadata: () => metadata2
});
var metadata2, Dizt;
var init_dizt_md = __esm({
  ".svelte-kit/output/server/entries/pages/projects/dizt.md.js"() {
    init_index_5f038599();
    metadata2 = { "title": "DIZT", "date": "2021-12-14" };
    Dizt = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<h1>Uses</h1>
<p><strong>DIZT</strong>
\u{1F9DF}\u{1F52B}</p>`;
    });
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    init_dizt_md();
    index6 = 4;
    entry6 = "pages/projects/dizt.md-7613a909.js";
    js6 = ["pages/projects/dizt.md-7613a909.js", "chunks/index-f6b2bc5e.js"];
    css6 = [];
  }
});

// .svelte-kit/output/server/entries/pages/projects/enigma-machine.md.js
var enigma_machine_md_exports = {};
__export(enigma_machine_md_exports, {
  default: () => Enigma_machine,
  metadata: () => metadata3
});
var metadata3, Enigma_machine;
var init_enigma_machine_md = __esm({
  ".svelte-kit/output/server/entries/pages/projects/enigma-machine.md.js"() {
    init_index_5f038599();
    metadata3 = {
    ...
    Enigma_machine = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<p><strong>Engima Machine</strong></p>
<img src="${"/enigmamachine.png"}" width="${"200"}" height="${"100"}">
<p><img src="${"/enigmamachine.png"}" alt="${"Alt Text"}" title="${"Title"}"></p>
<pre class="${"language-cpp"}"><!-- HTML_TAG_START -->${`<code class="language-cpp">
...
__export(__exports7, {
  ...
  index: () => index7,
  js: () => js7,
  module: () => enigma_machine_md_exports
});
var index7, entry7, js7, css7;
var init__7 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    init_enigma_machine_md();
    index7 = 5;
    entry7 = "pages/projects/enigma-machine.md-c41c5e82.js";
    js7 = ["pages/projects/enigma-machine.md-c41c5e82.js", "chunks/index-f6b2bc5e.js"];
    css7 = [];
  }
});

// .svelte-kit/output/server/entries/pages/projects/pumpkin-boy.md.js
var pumpkin_boy_md_exports = {};
__export(pumpkin_boy_md_exports, {
  default: () => Pumpkin_boy,
  metadata: () => metadata4
});
var metadata4, Pumpkin_boy;
var init_pumpkin_boy_md = __esm({
  ".svelte-kit/output/server/entries/pages/projects/pumpkin-boy.md.js"() {
    init_index_5f038599();
    metadata4 = {
      "title": "Pumpkin Boy",
    ...
    Pumpkin_boy = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<h1>Uses</h1>
<p><strong>Pumpkin boy?</strong>
\u{1F383}</p>`;
    });
  }
});
...
var init__8 = __esm({
  ".svelte-kit/output/server/nodes/6.js"() {
    init_pumpkin_boy_md();
    index8 = 6;
    entry8 = "pages/projects/pumpkin-boy.md-21768e04.js";
    js8 = ["pages/projects/pumpkin-boy.md-21768e04.js", "chunks/index-f6b2bc5e.js"];
    css8 = [];
  }
});

// .svelte-kit/output/server/entries/pages/projects/uses.md.js
var uses_md_exports = {};
__export(uses_md_exports, {
  default: () => Uses,
  metadata: () => metadata5
});
var metadata5, Uses;
var init_uses_md = __esm({
  ".svelte-kit/output/server/entries/pages/projects/uses.md.js"() {
    init_index_5f038599();
    metadata5 = {
      "title": "Placeholder",
...
var init__9 = __esm({
  ".svelte-kit/output/server/nodes/7.js"() {
    init_uses_md();
    index9 = 7;
    entry9 = "pages/projects/uses.md-c7ea11ae.js";
    js9 = ["pages/projects/uses.md-c7ea11ae.js", "chunks/index-f6b2bc5e.js"];
    css9 = [];
  }
});

// .svelte-kit/output/server/entries/endpoints/api/posts.json.js
...
var init_posts_json = __esm({
  ".svelte-kit/output/server/entries/endpoints/api/posts.json.js"() {
    get = async () => {
      const allPostFiles = { "../projects/addons.md": () => Promise.resolve().then(() => (init_addons_md(), addons_md_exports)), "../projects/dizt.md": () => Promise.resolve().then(() => (init_dizt_md(), dizt_md_exports)), "../projects/enigma-machine.md": () => Promise.resolve().then(() => (init_enigma_machine_md(), enigma_machine_md_exports)), "../projects/pumpkin-boy.md": () => Promise.resolve().then(() => (init_pumpkin_boy_md(), pumpkin_boy_md_exports)), "../projects/uses.md": () => Promise.resolve().then(() => (init_uses_md(), uses_md_exports)) };
      const iterablePostFiles = Object.entries(allPostFiles);
      const allPosts = await Promise.all(iterablePostFiles.map(async ([path, resolver]) => {
        const { metadata: metadata6 } = await resolver();
...
var manifest = {
  appDir: "_app",
  assets: /* @__PURE__ */ new Set([".nojekyll", "UnrealEnigmaMachine.mp4", "consoledrawingstuff.gif", "dizt.png", "enigmamachine.gif", "enigmamachine.png", "favicon.png", "itchio-textless-black.svg", "itchio-textless-white.svg", "prism-dracula.css", "profilepic.jpg", "pumpkinboy.png"]),
  mimeTypes: { ".mp4": "video/mp4", ".gif": "image/gif", ".png": "image/png", ".svg": "image/svg+xml", ".css": "text/css", ".jpg": "image/jpeg" },
  _: {
    entry: { "file": "start-5512cc40.js", "js": ["start-5512cc40.js", "chunks/index-f6b2bc5e.js"], "css": [] },
    nodes: [
